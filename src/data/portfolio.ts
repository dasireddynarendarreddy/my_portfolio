export const personalInfo = {
  ...
  twitter: 'https://x.com/narendarda42874',
...
export const experiences = [
  {
    company: 'Code Tree Software Solutions Pvt Ltd',
    role: 'Full Stack Developer',
    duration: '2025(July)-Present',
    type: 'Full-time',
    description:'Designed and delivered production-grade web applications across government and enterprise domains, including MDSS and ICDS systems, along with AI-powered and e-commerce platforms.Built and enhanced large-scale applications such as MDSS (Milk Data Smart System) and ICDS dashboards Focused on building scalable, high-performance, and user-centric web solutions.',
    highlights: [ 'Improved application performance by 35% through code splitting, lazy loading,and optimized API handling',' improving data visibility and operational efficiency'],
    color: '#6366f1',
  },
  {
    company: 'SelfEmployed',
    role: 'Freelance Full Stack Developer',
    duration: '2024— 2025(June)',
    type: 'Self-Directed',
